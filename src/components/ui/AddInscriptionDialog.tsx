        ...
        <div className="flex-1 overflow-y-auto px-6 py-5 space-y-4">
          ...
          <div>
            ...
            {selectedLead ? (
              ...
              <div className="relative">
                ...
                <input value={search} onChange={e => setSearch(e.target.value)} placeholder="Tapez un nom, email..." className="w-full pl-9 pr-4 py-2.5 rounded-lg border border-gray-200 text-sm min-h-[44px] focus:border-primary outline-none" />
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              <input type="number" value={form.montant_total} onChange={e => setForm(p => ({ ...p, montant_total: parseFloat(e.target.value) || 0 }))} className="w-full px-3 py-2.5 rounded-lg border border-gray-200 text-sm min-h-[44px] focus:border-primary outline-none" />
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">Montant financé</label>
              <input type="number" value={form.montant_finance} onChange={e => setForm(p => ({ ...p, montant_finance: parseFloat(e.target.value) || 0 }))} className="w-full px-3 py-2.5 rounded-lg border border-gray-200 text-sm min-h-[44px] focus:border-primary outline-none" />
            </div>
          </div>
          ...
          <div>
            ...
            <select value={form.mode_paiement} onChange={e => setForm(p => ({ ...p, mode_paiement: e.target.value as ModePaiement }))} className="w-full px-3 py-2.5 rounded-lg border border-gray-200 text-sm min-h-[44px] focus:border-primary outline-none">
          ...
          <div>
            ...
            <textarea value={form.notes} onChange={e => setForm(p => ({ ...p, notes: e.target.value }))} rows={2} className="w-full px-3 py-2.5 rounded-lg border border-gray-200 text-sm focus:border-primary outline-none" />
          </div>
        </div>
