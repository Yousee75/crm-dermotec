...
export function ClickToCall({ phone, className = '', showIcon = true, size = 'sm' }: ClickToCallProps) {
  ...
  return (
    <a
      ...
      className={`inline-flex items-center ${sizeClasses} rounded-lg bg-primary/5 text-[#0EA5E9] hover:bg-primary/15 hover:text-primary-dark transition-colors font-mono ${className}`}
