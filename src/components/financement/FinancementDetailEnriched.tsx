...
const STATUT_CONFIG = {
  PREPARATION: { label: 'Préparation', color: 'bg-[#F4F0EB] text-[#1A1A1A]', badge: 'default' },
  DOCUMENTS_REQUIS: { label: 'Documents requis', color: 'bg-orange-100 text-orange-800', badge: 'warning' },
  DOSSIER_COMPLET: { label: 'Dossier complet', color: 'bg-[#E0EBF5] text-[#6B8CAE]', badge: 'primary' },
  SOUMIS: { label: 'Soumis', color: 'bg-[#E0EBF5] text-[#6B8CAE]', badge: 'primary' },
  EN_EXAMEN: { label: 'En examen', color: 'bg-[#FFE0EF] text-[#FF2D78]', badge: 'info' },
  COMPLEMENT_DEMANDE: { label: 'Complément demandé', color: 'bg-orange-100 text-orange-800', badge: 'warning' },
  VALIDE: { label: 'Validé', color: 'bg-[#D1FAE5] text-[#10B981]', badge: 'success' },
  REFUSE: { label: 'Refusé', color: 'bg-[#FFE0EF] text-[#FF2D78]', badge: 'error' },
  VERSE: { label: 'Versé', color: 'bg-[#D1FAE5] text-[#10B981]', badge: 'success' },
  CLOTURE: { label: 'Clôturé', color: 'bg-[#F4F0EB] text-[#1A1A1A]', badge: 'default' }
} as const

// Configuration des types d'actions pour l'historique
const ACTION_CONFIG = {
  'Création': { color: 'bg-[#E0EBF5] text-[#6B8CAE]' },
    ...
    return (
      <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50">
        <Card className="p-6 text-center">
          <AlertCircle className="w-12 h-12 mx-auto text-[#FF2D78] mb-4" />
          <h2 className="text-lg font-semibold text-[#FF2D78] mb-2">Financement introuvable</h2>
    ...
    <AnimatePresence>
      ...
      >
        ...
        >
              ...
              <div className="flex items-center gap-4">
                <div>
                  ...
                  <div className="flex items-center gap-3 mt-2">
                    ...
                    <span className="text-[#6B8CAE]">{organisme?.sigle || financement.organisme}</span>
                    {financement.numero_dossier && (
                      <>
                        <span className="text-[#6B8CAE]">•</span>
                        <span className="text-[#6B8CAE] font-mono text-sm">{financement.numero_dossier}</span>
                      </>
                    )}
                  </div>
                </div>
          ...
          {/* Tabs */}
          <div className="border-b border-[#F4F0EB]">
                ...
                >
                    ...
                    <Card className="p-6">
                      ...
                      <div className="flex items-center gap-4 mb-4">
                        ...
                        <div>
                          ...
                          <div className="flex items-center gap-4 mt-2 text-sm text-[#777777]">
                    ...
                    <Card className="p-6">
                      ...
                      <div className="space-y-4">
                        {financement.montant_demande && (
                          <div>
                            <div className="flex justify-between items-center mb-2">
                              <span className="text-[#777777]">Demandé</span>
                        ...
                        {financement.montant_accorde && (
                          <div>
                            <div className="flex justify-between items-center mb-2">
                              <span className="text-[#777777]">Accordé</span>
                              <span className="font-semibold text-lg text-[#10B981]">{formatEuro(financement.montant_accorde)}</span>
                            </div>
                            <div className="w-full bg-[#EEEEEE] rounded-full h-2">
                              <motion.div
                                initial={{ width: 0 }}
                        ...
                        {financement.montant_verse > 0 && (
                          <div>
                            <div className="flex justify-between items-center mb-2">
                              <span className="text-[#777777]">Versé</span>
                      ...
                      <div className="space-y-3">
                        {financement.date_soumission && (
                          <div className="flex justify-between">
                            <span className="text-[#777777]">Soumission</span>
                    ...
                    {isEditing ? (
                      <div className="space-y-4">
                        <textarea
                          ...
                          className="w-full min-h-[120px] p-3 border border-[#EEEEEE] rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent"
                  ...
                  <Card className="p-6">
                    <div className="flex items-center gap-4">
                      ...
                      <Button variant="outline" className="text-[#FF2D78] hover:text-[#FF2D78]">
                    ...
                    <Card className="p-6">
                      ...
                      <div className="space-y-4">
                        ...
                        <div>
                          ...
                          <div className="flex items-center gap-3">
                            <input
                              ...
                              className="flex-1 px-3 py-2 border border-[#EEEEEE] rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent"
                              min="0"
                              step="50"
                            />
                            <span className="text-[#777777]">€</span>
                          </div>
                          <p className="text-xs text-[#777777] mt-1">Référence marché : 350€/jour</p>
                        </div>
                        ...
                        <div>
                          ...
                          <p className="text-xs text-[#777777] mt-1">Référence : 150€/jour</p>
                        </div>
                        ...
                        <div>
                          ...
                          <p className="text-xs text-[#777777] mt-1">Calcul auto : km × 0,32€</p>
                        </div>
                        ...
                        <div>
                          ...
                          <p className="text-xs text-[#777777] mt-1">Référence : 80€/dossier</p>
                        </div>
                        ...
                        <div>
                          ...
                          <textarea
                            ...
                            className="w-full mt-2 px-3 py-2 border border-[#EEEEEE] rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent text-sm"
                      ...
                      <Card className="p-6">
                        ...
                        <div className="space-y-4">
                          <motion.div
                            ...
                            animate={{ scale: 1 }}
                            transition={{ type: "spring", duration: 0.3 }}
                            className="text-center p-4 bg-[#FAF8F5] rounded-lg"
                          >
                            <p className="text-sm text-[#777777] mb-1">COÛT TOTAL</p>
                          ...
                          <motion.div
                            ...
                            className={cn(
                              ...
                              calculsCouts.margeNette >= 0 ? "bg-[#ECFDF5]" : "bg-[#FFE0EF]"
                            )}
                          >
                            <p className="text-sm text-[#777777] mb-1">MARGE NETTE</p>
                            <p className={cn(
                              "text-3xl font-bold",
                              calculsCouts.margeNette >= 0 ? "text-[#10B981]" : "text-[#FF2D78]"
                            )}>
                          ...
                          <motion.div
                            ...
                            className="p-4 bg-[#E0EBF5] rounded-lg"
                          >
                            <p className="text-sm text-[#777777] mb-2">TAUX DE MARGE</p>
                            <div className="flex items-center gap-3 mb-2">
                              <div className="flex-1 bg-[#EEEEEE] rounded-full h-3">
                                <motion.div
                                  initial={{ width: 0 }}
                                  ...
                                  className={cn(
                                    "h-3 rounded-full",
                                    calculsCouts.tauxMarge < 0 ? "bg-[#FF2D78]" :
                                    calculsCouts.tauxMarge < 15 ? "bg-orange-500" :
                                    calculsCouts.tauxMarge < 30 ? "bg-[#FF8C42]" :
                                    "bg-[#10B981]"
                                  )}
                                />
                              </div>
                            ...
                            <Badge
                              variant="outline"
                              className={cn(
                                calculsCouts.tauxMarge < 0 ? "border-[#FF2D78]/30 text-[#FF2D78] bg-[#FFE0EF]" :
                                calculsCouts.tauxMarge < 15 ? "border-orange-200 text-orange-800 bg-orange-50" :
                                calculsCouts.tauxMarge < 30 ? "border-[#FF8C42]/30 text-[#FF8C42] bg-[#FFF3E8]" :
                          ...
                          <div className="p-4 bg-[#E0EBF5] rounded-lg border border-[#6B8CAE]/30">
                            <div className="flex items-start gap-2">
                              ...
                              <div>
                                <p className="font-medium text-[#6B8CAE]">Recommandation</p>
                                <p className="text-sm text-[#6B8CAE] mt-1">{calculsCouts.recommandation}</p>
                              </div>
                            </div>
                          </div>
                          ...
                          {calculsCouts.seuilRentabilite > 0 && (
                            <div className="p-4 bg-[#FAF8F5] rounded-lg">
                              <p className="text-sm text-[#777777]">Seuil de rentabilité</p>
              ...
              <TabsContent value="tva" className="mt-0">
                ...
                >
                    ...
                    <div className="space-y-4">
                      <div className="flex items-center gap-3">
                        <input
                          ...
                          className="w-5 h-5 text-primary border-[#EEEEEE] rounded focus:ring-primary"
                        />
                        <label className="font-medium">Exonération TVA (Article 261-4-4° CGI)</label>
                      </div>

                      {exonerationTVA ? (
                        <div className="p-4 bg-[#E0EBF5] border border-[#6B8CAE]/30 rounded-lg">
                          <div className="flex items-start gap-2">
                            <Info className="w-5 h-5 text-[#6B8CAE] mt-0.5" />
                          ...
                          <div className="mt-4 p-3 bg-white rounded border">
                            <p className="text-sm font-medium text-[#3A3A3A]">Montant</p>
                        ...
                        <div className="space-y-4">
                          <div>
                            <label className="block text-sm font-medium text-[#3A3A3A] mb-2">Taux TVA</label>
                            <select
                              value={tauxTVA}
                              onChange={(e) => setTauxTVA(Number(e.target.value))}
                              className="px-3 py-2 border border-[#EEEEEE] rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent"
                            >
                          ...
                          <div className="p-4 bg-[#ECFDF5] border border-[#10B981]/30 rounded-lg">
                            <div className="flex items-start gap-2">
                              <CheckCircle2 className="w-5 h-5 text-[#10B981] mt-0.5" />
                              <p className="text-sm text-[#10B981]">L'OF peut récupérer la TVA sur ses achats</p>
                            </div>
                    ...
                    <div className="space-y-4">
                      ...
                      {!qualiopiValide && (
                        <div className="p-4 bg-[#FFE0EF] border border-[#FF2D78]/30 rounded-lg">
                          <div className="flex items-start gap-2">
                            <AlertCircle className="w-5 h-5 text-[#FF2D78] mt-0.5" />
                            <div className="text-sm text-[#FF2D78]">
                  ...
                  <Card className="p-6">
                    ...
                    <div className="space-y-4">
                      <div>
                        <label className="block text-sm font-medium text-[#3A3A3A] mb-2">Numéro NDA</label>
                        <input
                          type="text"
                          value={numerNDA}
                          onChange={(e) => setNumerNDA(e.target.value)}
                          className="w-full px-3 py-2 border border-[#EEEEEE] rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent"
                  ...
                  <Card className="p-6">
                    ...
                    <div className="space-y-3">
                      <div className="p-3 bg-[#FAF8F5] rounded-lg">
                        <p className="text-sm font-medium text-[#3A3A3A]">Mentions obligatoires</p>
                        <ul className="text-sm text-[#777777] mt-2 space-y-1">
                      ...
                      <div className="p-3 bg-[#E0EBF5] rounded-lg border border-[#6B8CAE]/30">
                        <p className="text-sm text-[#6B8CAE]">
                  ...
                  <div className="space-y-4">
                    ...
                    <motion.div
                      initial={{ opacity: 0, x: -20 }}
                      animate={{ opacity: 1, x: 0 }}
                      className="p-4 bg-[#FFF3E8] border border-[#FF8C42]/30 rounded-lg"
                    >
                      <div className="flex items-start gap-2">
                        <Calendar className="w-5 h-5 text-[#FF8C42] mt-0.5" />
                        <div className="text-sm text-[#FF8C42]">
                    ...
                    <motion.div
                      ...
                      className="p-4 bg-[#FFE0EF] border border-[#FF2D78]/30 rounded-lg"
                    >
                      <div className="flex items-start gap-2">
                        <DollarSign className="w-5 h-5 text-[#FF2D78] mt-0.5" />
                        <div className="text-sm text-[#FF2D78]">
                          ...
                          <div className="space-y-3">
                            {lignesFinancement.map((ligne, index) => (
                              <motion.div
                                ...
                                animate={{ opacity: 1, y: 0 }}
                                transition={{ delay: index * 0.1 }}
                                className="flex items-center gap-3 p-4 bg-[#FAF8F5] rounded-lg"
                              >
                                <select
                                ...
                                <input
                                  ...
                                  className="w-32 px-3 py-2 border border-[#EEEEEE] rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent"
                                  placeholder="Montant"
                                />
                                <select
                                  value={ligne.statut}
                                  ...
                                  className="w-40 px-3 py-2 border border-[#EEEEEE] rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent"
                                >
                                ...
                                <Button
                                  ...
                                  className="text-[#FF2D78] hover:text-[#FF2D78]"
                                >
                          ...
                          {calculsMultiFinancement && (
                            <div className="mt-6 space-y-4">
                              ...
                              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                                <div className="p-3 bg-[#E0EBF5] rounded-lg text-center">
                                  <p className="text-xs text-[#777777] mb-1">Total demandé</p>
                                  <p className="font-bold text-[#6B8CAE]">{formatEuro(calculsMultiFinancement.totalDemande)}</p>
                                </div>
                                <div className="p-3 bg-[#ECFDF5] rounded-lg text-center">
                                  <p className="text-xs text-[#777777] mb-1">Total accordé</p>
                                  <p className="font-bold text-[#10B981]">{formatEuro(calculsMultiFinancement.totalAccorde)}</p>
                                </div>
                                <div className={cn(
                                  "p-3 rounded-lg text-center",
                                  calculsMultiFinancement.resteACharge > 0 ? "bg-[#FFE0EF]" : "bg-[#ECFDF5]"
                                )}>
                                  <p className="text-xs text-[#777777] mb-1">Reste à charge</p>
                                  <p className={cn(
                                    "font-bold",
                                    calculsMultiFinancement.resteACharge > 0 ? "text-[#FF2D78]" : "text-[#10B981]"
                                  )}>
                                    {formatEuro(calculsMultiFinancement.resteACharge)}
                                  </p>
                                </div>
                                <div className="p-3 bg-[#FFE0EF] rounded-lg text-center">
                                  <p className="text-xs text-[#777777] mb-1">Taux couverture</p>
                                  <p className="font-bold text-[#FF2D78]">{calculsMultiFinancement.tauxCouverture.toFixed(1)}%</p>
                                </div>
                              </div>

                              <div className="p-4 bg-[#FAF8F5] rounded-lg">
                                <p className="text-sm font-medium text-[#3A3A3A] mb-2">Progression du financement</p>
                                <div className="w-full bg-[#EEEEEE] rounded-full h-3">
                                  <motion.div
                                    ...
                                    className={cn(
                                      "h-3 rounded-full",
                                      calculsMultiFinancement.tauxCouverture >= 100 ? "bg-[#10B981]" : "bg-orange-500"
                                    )}
                                  />
                                </div>
                              </div>
                              ...
                              {calculsMultiFinancement.totalDemande > calculsMultiFinancement.montantFormation && (
                                <div className="p-4 bg-[#FFF3E8] border border-[#FF8C42]/30 rounded-lg">
                                  <div className="flex items-start gap-2">
                                    <AlertCircle className="w-5 h-5 text-[#FF8C42] mt-0.5" />
              ...
              <TabsContent value="historique" className="mt-0">
                ...
                >
                  ...
                  <Card className="p-6">
                    <div className="flex items-center justify-between mb-4">
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <select
                          ...
                          className="px-3 py-2 border border-[#EEEEEE] rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent text-sm"
                        >
                    ...
                    {/* Ajouter une note */}
                    <div className="mb-6 p-4 bg-[#E0EBF5] rounded-lg">
                      <h4 className="font-medium text-[#6B8CAE] mb-3">Ajouter une note</h4>
                      <div className="space-y-3">
                        <textarea
                          value={newNote}
                          onChange={(e) => setNewNote(e.target.value)}
                          className="w-full px-3 py-2 border border-blue-300 rounded-lg focus:ring-2 focus:ring-[#FF5C00] focus:border-transparent"
                    ...
                    <div className="space-y-4">
                      {financement.historique && financement.historique.length > 0 ? (
                        <div className="relative">
                          <div className="absolute left-4 top-0 bottom-0 w-0.5 bg-[#EEEEEE]" />
                          {financement.historique
                            .filter(entry =>
                              ...
                              return (
                                ...
                                >
                                  ...
                                  <div className="bg-white border border-[#EEEEEE] rounded-lg p-4 shadow-sm">
                                    ...
                                    {entry.detail && (
                                      <p className="text-sm text-[#3A3A3A] bg-[#FAF8F5] p-3 rounded-lg">
                                        {entry.detail}
                                      </p>
                                    )}
                                  </div>
                        ...
                        <div className="text-center py-12">
                          ...
                          <h4 className="text-lg font-medium text-[#777777] mb-2">Aucune modification enregistrée</h4>
                          <p className="text-[#999999]">L'historique des modifications apparaîtra ici.</p>
                        </div>
                      )}
                    </div>
                  </Card>
