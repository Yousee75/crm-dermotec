          ...
          <div className="lg:col-span-1">
            <div className="sticky top-8">
              ...
              <nav className="space-y-2 text-sm">
                <a href="#objet" className="block text-[#777777] hover:text-primary transition-colors">
                  1. Ce que fait Dermotec CRM
                </a>
                <a href="#definitions" className="block text-[#777777] hover:text-primary transition-colors">
                  2. Les mots importants
                </a>
                <a href="#inscription" className="block text-[#777777] hover:text-primary transition-colors">
                  3. Comment ça marche
                </a>
                <a href="#tarifs" className="block text-[#777777] hover:text-primary transition-colors">
                  4. Combien ça coûte
                </a>
                <a href="#donnees" className="block text-[#777777] hover:text-primary transition-colors">
                  5. Vos données vous appartiennent
                </a>
                <a href="#propriete" className="block text-[#777777] hover:text-primary transition-colors">
                  6. Ce qui est à vous, ce qui est à nous
                </a>
                <a href="#disponibilite" className="block text-[#777777] hover:text-primary transition-colors">
                  7. Notre engagement de service
                </a>
                <a href="#responsabilite" className="block text-[#777777] hover:text-primary transition-colors">
                  8. Nos limites
                </a>
                <a href="#resiliation" className="block text-[#777777] hover:text-primary transition-colors">
                  9. Comment arrêter
                </a>
                <a href="#droit" className="block text-[#777777] hover:text-primary transition-colors">
                  10. Droit applicable
                </a>
              </nav>
            </div>
          ...
          <div className="lg:col-span-3 space-y-8">
            ...
            <section id="definitions" className="bg-[#FAF8F5] rounded-lg p-8">
              ...
              <div className="grid gap-4">
                <div className="bg-white p-4 rounded border-l-4 border-primary">
                  <h3 className="font-semibold text-[#111111] mb-2">Client</h3>
                  <p className="text-[#3A3A3A]">Votre centre de formation qui souscrit à un plan Dermotec CRM</p>
                </div>
                <div className="bg-white p-4 rounded border-l-4 border-primary">
                  <h3 className="font-semibold text-[#111111] mb-2">Utilisateur</h3>
                  <p className="text-[#3A3A3A]">Toute personne de votre équipe qui a accès au logiciel</p>
                </div>
                <div className="bg-white p-4 rounded border-l-4 border-primary">
                  <h3 className="font-semibold text-[#111111] mb-2">Vos Données</h3>
                  <p className="text-[#3A3A3A]">Tout ce que vous saisissez : leads, stagiaires, documents, sessions, etc.</p>
                </div>
                <div className="bg-white p-4 rounded border-l-4 border-primary">
                  <h3 className="font-semibold text-[#111111] mb-2">Données d'Usage</h3>
                  <p className="text-[#3A3A3A]">Les informations techniques sur votre utilisation du logiciel (connexions, clics, performances)</p>
                </div>
                <div className="bg-white p-4 rounded border-l-4 border-primary">
                  <h3 className="font-semibold text-[#111111] mb-2">Insights</h3>
                  <p className="text-[#3A3A3A]">Les scores, analyses et statistiques que génère notre intelligence artificielle</p>
                </div>
              </div>
            </section>
            ...
            <section id="inscription" className="bg-white rounded-lg p-8 shadow-sm">
              ...
              <div className="space-y-4 text-[#3A3A3A]">
                ...
                <div className="bg-[#FFF3E8] border border-[#FF8C42]/30 rounded-lg p-4">
            ...
            <section id="tarifs" className="bg-[#FAF8F5] rounded-lg p-8">
              ...
              <div className="grid md:grid-cols-2 gap-6 mb-6">
                <div className="bg-white p-6 rounded-lg border">
                  ...
                  <div className="text-2xl font-bold text-[#111111] mb-3">Gratuit</div>
                  <ul className="text-sm text-[#777777] space-y-1 mb-4">
                    <li>• 1 utilisateur</li>
                    <li>• 50 leads maximum</li>
                    <li>• Pipeline simple</li>
                    <li>• Fonctions de base</li>
                  </ul>
                  <p className="text-xs text-[#777777]">Pour découvrir et tester</p>
                </div>

                <div className="bg-white p-6 rounded-lg border border-primary">
                  <h3 className="font-bold text-lg text-accent mb-2">Pro</h3>
                  <div className="text-2xl font-bold text-[#111111] mb-1">29€ HT/mois</div>
                  <div className="text-sm text-[#777777] mb-3">35€ TTC/mois</div>
                  <ul className="text-sm text-[#777777] space-y-1 mb-4">
                  ...
                  <p className="text-xs text-[#777777]">Pour les centres actifs</p>
                </div>

                <div className="bg-white p-6 rounded-lg border">
                  <h3 className="font-bold text-lg text-accent mb-2">Expert</h3>
                  <div className="text-2xl font-bold text-[#111111] mb-1">79€ HT/mois</div>
                  <div className="text-sm text-[#777777] mb-3">95€ TTC/mois</div>
                  <ul className="text-sm text-[#777777] space-y-1 mb-4">
                  ...
                  <p className="text-xs text-[#777777]">Pour optimiser et grandir</p>
                </div>

                <div className="bg-white p-6 rounded-lg border">
                  <h3 className="font-bold text-lg text-accent mb-2">Clinique</h3>
                  <div className="text-2xl font-bold text-[#111111] mb-3">Sur devis</div>
                  <ul className="text-sm text-[#777777] space-y-1 mb-4">
                  ...
                  <p className="text-xs text-[#777777]">Pour les groupes et réseaux</p>
                </div>
              </div>
            ...
            <section id="propriete" className="bg-[#FAF8F5] rounded-lg p-8">
              ...
              <div className="mt-6 bg-[#FFF3E8] border border-[#FF8C42]/30 rounded-lg p-4">
              ...
              <div className="space-y-4 text-[#3A3A3A]">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="bg-[#ECFDF5] p-4 rounded-lg">
                    <h4 className="font-semibold text-[#10B981] mb-2">Ce que nous garantissons</h4>
                    <ul className="text-[#10B981] space-y-1 text-sm">
                  ...
                  <div className="bg-[#E0EBF5] p-4 rounded-lg">
                    <h4 className="font-semibold text-[#6B8CAE] mb-2">Maintenances</h4>
                    <ul className="text-[#6B8CAE] space-y-1 text-sm">
              ...
              <div className="space-y-4 text-[#3A3A3A]">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="bg-white p-4 rounded-lg border-l-4 border-red-300">
                    <h4 className="font-semibold text-[#FF2D78] mb-2">Exclusions</h4>
                    <ul className="text-[#FF2D78] space-y-1 text-sm">
                  ...
                  <div className="bg-white p-4 rounded-lg border-l-4 border-green-300">
                    <h4 className="font-semibold text-[#10B981] mb-2">Notre engagement</h4>
                    <ul className="text-[#10B981] space-y-1 text-sm">
            ...
            <section id="resiliation" className="bg-white rounded-lg p-8 shadow-sm">
              ...
              <div className="space-y-4 text-[#3A3A3A]">
                ...
                <div className="bg-[#E0EBF5] border border-[#6B8CAE]/30 rounded-lg p-4">
                  <h4 className="font-semibold text-[#6B8CAE] mb-2">Récupération de vos données</h4>
                  <p className="text-[#6B8CAE] text-sm">
